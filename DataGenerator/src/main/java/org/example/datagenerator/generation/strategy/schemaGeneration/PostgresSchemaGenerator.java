...
@Slf4j
public class PostgresSchemaGenerator extends AbstractSchemaGenerationStrategy {

    public PostgresSchemaGenerator(DataSource dataSource) {
        super(dataSource);
    }
    ...
    public void createSchema() {
        try (Connection conn = dataSource.getConnection()) {
            ...
            throw new RuntimeException("Failed to create PostgreSQL schema", e);
        }
    }
}
